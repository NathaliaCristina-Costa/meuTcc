            ...
            <div class="content-body">
                ...
                <div class="row page-titles mx-0">
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="servico.php">Serviços</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><a href="cadastroServico.php"><button type="button" class="btn btn-dark">Adicionar</button></a></h6>
                        </div>
                        <div class="card-body">
