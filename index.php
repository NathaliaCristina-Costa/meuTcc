    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a class="nav-link rounded js-scroll-trigger" id="cor-link"
                                        href="#portfolio"><small>Categorias</small></a></li>
                <li class="nav-item"><a class="nav-link rounded js-scroll-trigger" href="#about"><small>Quem
                            somos</small></a></li>
                <li class="nav-item"><a class="nav-link rounded js-scroll-trigger"
                                        href="#cadastro"><small>Cadastro</small></a></li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="src/view/freelancer/login.php"><small><i
                                        class="fas fa-people-carry"></i> Freelancer</small></a>
                        <a class="dropdown-item" href="src/view/cliente/login.php"><small><i
                                        class="fas fa-user-friends"></i> Cliente</small></a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 mb-5 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid" src="assets/img/eventos.jpg" alt=""/>
                </div>
            </div>
            <!-- Portfolio Item 2-->
            <div class="col-md-6 col-lg-4 mb-5 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid " src="assets/img/reforma.jpg" alt=""/>
                </div>
            </div>
            <!-- Portfolio Item 3-->
            <div class="col-md-6 col-lg-4 mb-5 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid" src="assets/img/saude.jpg" alt=""/>
                </div>
            </div>
            <!-- Portfolio Item 4-->
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
                    ...
                    <img class="img-fluid" src="assets/img/domestico.jpg" alt=""/>
                </div>
            </div>
            <!-- Portfolio Item 5-->
            <div class="col-md-6 col-lg-4 mb-5 mb-md-0 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid" src="assets/img/tecnologia.jpeg" alt=""/>
                </div>
            </div>
            <!-- Portfolio Item 6-->
            <div class="col-md-6 col-lg-4 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid" src="assets/img/assistencia-tecnica-computadores.jpg" alt=""/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <p class="fs-1 text-center" data-animation-name="bounceIn" data-animation-duration="1000"
               data-animation-delay="0" data-animation-direction="">Criada e desenvolvida por quatro estudantes de
                analise e
                desenvolvimento de
                sistemas, que
                em meio uma pandemia que dura a um pouco mais de 1 ano e meio, surgiu-se a idéia de criar uma pequena
                startup
                para que o indice de desemprego que chega no momento a 14,7% diminuisse, gerando renda para algumas
                familias.
            </p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <a class="col-md-6 col-lg-4 mb-5 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
               href="src/view/freelancer/cadastroFreelancer.php">
                <div class="cadastro-item mx-auto">
                    <div class="cadastro-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                        <div class="cadastro-item-caption-content text-center text-white"><i
                                    class="fas fa-user-plus"></i>
                            <p>Seja Freelancer</p>
                        </div>
                    </div>
                    <img class="img-fluid" src="assets/img/freelancer-cadastro.jpg" alt=""/>
                </div>
            </a>
            <!-- Portfolio Item 2-->
            <a class="col-md-6 col-lg-4 mb-5 nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
               href="src/view/cliente/cadastroCliente.php"">
            <div class=" cadastro-item mx-auto">
                <div class="cadastro-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                ...
                <img class="img-fluid " src="assets/img/cliente.jpg" alt=""/>
            </div>
            </a>
        </div>
</section>
...
<!-- Footer-->
<!-- Copyright Section-->
<footer class="copyright p-4 text-center text-white" style="background-color: #000c;">
    <p>Projeto Final</p>
