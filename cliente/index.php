    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="categoria.php"><i class="fas fa-bars mr-2 text-gray-400"></i> Pedidos que Fiz</a>
                </li>
                <li>
                    <a href="servico.php"><i class="fas fa-bars mr-2 text-gray-400"></i> Novo Pedidos</a>
                </li>
                <li>
