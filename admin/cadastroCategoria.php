    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="categoria/cadastroCategoria.php"><i class="fas fa-bars mr-2 text-gray-400"></i> Categorias</a>
                </li>
                <li>
                    <a href="servico/index.php"><i class="fas fa-bars mr-2 text-gray-400"></i> Serviços</a>
                </li>
                <li>
                    <a href="#"><i class="fas fa-people-carry mr-2 text-gray-400"></i> Freelancers</a>
                </li>
                <li>
                    <a href="#"><i class="fas fa-user-friends mr-2 text-gray-400"></i> Clientes</a>
                </li>
                <li>
                    <a href="#"><i class="fas fa-comments mr-2 text-gray-400"></i> Mensagens do Atendimento</a>
                </li>
                <li>
