    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" s>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="categoria.php"><i class="fas fa-hand-holding-usd mr-2 text-gray-400"></i> Pedidos que
                        Fiz</a>
                </li>
                <li>
                ...
                <li>
                    <a href="atendimentoCliente.php"><i class="fas fa-comments mr-2 text-gray-400"></i> Atendimento ao
                        Cliente</a>
                </li>
                <li>
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total de
                                        Clientes
                                    </div>
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
